...
def lambda_handler(event, context):
    ...
    url = "https://search-photos-fdkohr7xq5ey3n3h4su3ktqm5m.us-east-1.es.amazonaws.com/photo/_doc/"
    headers = {"Content-Type": "application/json"}
    r = requests.post(url,auth=('Aakash', 'Elastic@369'),data=json.dumps(format).encode("utf-8"), headers=headers)
    return {
        'statusCode': 200,
